...
public sealed class SaveIdolSpriteImportPostprocessor : AssetPostprocessor
{
        ...
        string[] movedFromAssetPaths)
    {
        ...
        {
            if (!IsIdolSprite(importedAssets[i]))
            {
                continue;
            }
    ...
    private static bool IsIdolSprite(string path)
    {
    ...
    private static void BuildPrefabAfterImport()
    {
        ...
        SaveIdolPrefabSetupEditor.BuildPrefab();
    }
}
